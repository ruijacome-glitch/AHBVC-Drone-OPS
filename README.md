...
- Mission report PDFs generated by an internal Gotenberg service, stored in MinIO, and deliverable by SMTP
- Secure email invitations with single-use account activation links
- Organisation-scoped local occurrence and mission management
- Multiple planned flight records per mission
