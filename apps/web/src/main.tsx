...
function formatShareExpiry(expiresAt: string | null): string {
  return expiresAt ? new Date(expiresAt).toLocaleString("pt-PT") : "Permanente";
}
...
function LiveStreamPage() {
  ...
  const [sharePermanent, setSharePermanent] = React.useState(false);
